...
import pg from 'pg';
const sql = readFileSync('database/migrations/008-adaptive-learning-governance.up.sql','utf8');
...
try { await c.query('BEGIN'); await c.query(sql); await c.query('COMMIT'); console.log('Migration 008 OK'); }
