...
import pg from 'pg';
const sql = readFileSync('database/migrations/005-path-elimination-convergence.up.sql','utf8');
...
try { await c.query('BEGIN'); await c.query(sql); await c.query('COMMIT'); console.log('Migration 005 OK'); }
